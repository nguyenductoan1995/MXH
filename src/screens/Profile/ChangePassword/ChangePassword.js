  ...
  render() {
    return (
      <Block style={styles.contain}>
        <Header onPressLeftIcon={this.goBack} title="Change Password" />
        <Block flex={1} center>
          <Input secureTextEntry autoFocus style={styles.input} placeholder="Current Password" />
          <Input secureTextEntry style={styles.input} placeholder="New Password" />
